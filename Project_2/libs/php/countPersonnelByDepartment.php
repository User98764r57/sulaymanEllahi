<?php
	...
	$countQuery = $conn->prepare('SELECT COUNT(*) as count FROM personnel WHERE departmentID = ?');
	$countQuery->bind_param("i", $_POST['departmentID']);
	$countQuery->execute();
	...
	$output['data']['count'] = $countResult['count'];
