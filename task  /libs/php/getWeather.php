...
if (file_exists($cacheFile) && (time() - filemtime($cacheFile)) < $cacheTime) {
    ...
    $url = 'http://api.geonames.org/weatherJSON?formatted=true&north=' . $_REQUEST['north'] . '&south=' . $_REQUEST['south'] . '&east=' . $_REQUEST['east'] . '&west=' . $_REQUEST['west'] . '&username=sulayman2e';
